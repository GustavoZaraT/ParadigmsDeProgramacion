#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#/*Cälculo de curva Z-spline en n dimenciones*/
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#/*GustavoZaraT ESFM 2023 :P*/
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
import numpy as np
...
class Curva:
    ...
    def interpolacion(s, p : int = 0, r : float = 0.0) -> list:
        ...
        a : np.float = r * s.L * rdx - float(i) # Distacia normalizada
        ...
        # Interpolación quíntica C2
            ...
            zm2 : np.float64 = 18.0 + u12 * am2 * (-459.0 + am2 * (382.5 + am2 * (-156.5 + am2 * (31.5 + 2.5 * apm2))))
            ...
            print("La suavidad debe ser de 0, 1 ó 2")

        return xi

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Función spline crea el Z-spline de un conjunto de puntos en dim dimenciones,
