class ClienteBancario:
    ...
    def __init__(self, nombres:str, apellidos:str, edad:int=0, balanceDeCuenta:float=0.0):
        ...
        self.__edad = edad
        self.balanceDeCuenta = balanceDeCueta
    ...
    def __enxiarBalanceAlBanco(self, cantidad:float) -> None:
    ...
    def impirimirINfo(self) -> str:
        return "Nombre: " + self.getNombreCompleto() + ", Edad: " + str(self.__edad) + ", Balance: " + str(self__balanceDeCuenta)
    ...
    def guardarDinero(self, cantidad:float) -> None:
        self.balanceDeCuenta = self.__balanceDeCuenta + cantidad
